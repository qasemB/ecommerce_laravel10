...
class OrderController extends Controller
{
    ...
    {
        $todayCarts = Cart::where('created_at', '>=', Carbon::now()->startOfDay())->count();
        ...
        $todayPendingOrders = Order::where('created_at', '>=', Carbon::now()->startOfDay())->where('pay_at', '=', null)->count();
        ...
        $todaySuccessOrders = Order::where('pay_at', '>=', Carbon::now()->startOfDay())->count();
        ...
        $todaySuccessOrdersAmount = Order::where('pay_at', '>=', Carbon::now()->startOfDay())->sum('pay_amount');
